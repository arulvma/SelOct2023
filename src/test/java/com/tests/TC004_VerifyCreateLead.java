...
public class TC004_VerifyCreateLead extends ProjectGeneric {
	...
	public void loginAndLogout(String userName, String passWord, String sample) throws Exception {		
		...
		new SignInPage(driver).enterUsername(userName).enterPassWord(passWord).clickSubmit().verifyHomePage()
			...
			.clickCreateLeadLink().enterLeadCompanyNam().enterLeadFirstNam().enterLeadLastNam().enterLeadPinCod().clickCreateLeadBtn().verifyLeadCreation();
	}
}
